...
cd obj
REM link /MACHINE:X64  /DEFAULTLIB:..\..\..\..\libzmq\bin\x64\Release\v120\dynamic\libzmq.lib /OUT:jzmq.x64.dll /DLL *.obj
link /MACHINE:X86  /DEFAULTLIB:..\..\..\..\libzmq\bin\Win32\Release\v120\dynamic\libzmq.lib /OUT:jzmq.x86.dll /DLL *.obj
cd ..
